...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class MouseLookMobile : FsmStateAction
	{
		...
		float GetXRotation()
		{
			rotationX += sideRecoil.Value + AxisX.Value * sensitivityX.Value;
		...
		float GetYRotation()
		{
			rotationY += upRecoil.Value + AxisY.Value * sensitivityY.Value;
